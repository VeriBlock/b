# Bootstrappable Bitcoinsq Core Builds

This directory contains the files necessary to perform bootstrappable Bitcoinsq
Core builds.
...
- 24GB of free disk space on the partition that the Bitcoinsq Core git repository
  resides in
...
For a Bitcoinsq Core depends development environment, simply invoke
...
From the top of a clean Bitcoinsq Core repository:
...
To use dongcarl's substitute server for Bitcoinsq Core builds after having
