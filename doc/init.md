...
All three Linux startup configurations assume the existence of a "bitcoinsq" user
...
`/etc/bitcoinsq/bitcoinsq.conf` with the current systemd, OpenRC, and Upstart init
files out-of-the-box. This is because the command line options specified in the
init files take precedence over the configurations in
`/etc/bitcoinsq/bitcoinsq.conf`. However, some init systems have their own
...
Configuration file:  `~/Library/Application Support/Bitcoinsq/bitcoinsq.conf`
