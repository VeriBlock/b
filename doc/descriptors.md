# Support for Output Descriptors in Bitcoinsq Core

Since Bitcoinsq Core v0.17, there is support for Output Descriptors. This is a
...
on Bitcoinsq's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bitcoinsq Core wallets, a convenience function `combo` is
...
All RPCs in Bitcoinsq Core will include the checksum in their output. Only
