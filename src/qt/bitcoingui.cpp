...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitcoinsq address"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitcoinsq addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Bitcoinsq command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Bitcoinsq network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
