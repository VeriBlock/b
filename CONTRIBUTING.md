Contributing to Bitcoinsq Core
============================

The Bitcoinsq Core project operates an open contributor model where anyone is
...
Most communication about Bitcoinsq Core development happens on Discord (https://discord.gg/wJZEjry), in the
...
Whether a pull request is merged into Bitcoinsq Core rests with the project merge
...
Patches that change Bitcoinsq consensus rules are considerably more involved than
...
The project leader is the release manager for each Bitcoinsq Core release.
